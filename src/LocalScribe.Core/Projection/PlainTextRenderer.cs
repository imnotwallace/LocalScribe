...
public static class PlainTextRenderer
{
    ...
    /// <summary>The engine segment of the header line - MarkdownRenderer's rule, applied to
    /// transcript.txt (2026-08-11 final review M-b). A session that transcribed nothing leaves
    /// Model/Backend empty so that no engine is CLAIMED; rendering "... - 5 min - /" turns that
    /// deliberate silence into a visible nonsense claim. A salvaged import is exactly this case
    /// and its transcript.txt is regenerated BY the salvage path.</summary>
