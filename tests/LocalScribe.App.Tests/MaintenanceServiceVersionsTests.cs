...
public sealed class MaintenanceServiceVersionsTests : IDisposable
{
    ...
    public async Task ExportDocx_footer_carries_the_title_and_no_model_name()
    {
        ...
        await svc.ExportDocxAsync(id, dest, new ExportOptions(), CancellationToken.None);
        ...
        await svc.ExportDocxAsync(id, dest1, new ExportOptions(), CancellationToken.None);
    ...
    public async Task ExportMarkdown_has_no_footer_block_on_any_active_version()
    {
        ...
        await svc.ExportMarkdownAsync(id, dest, new ExportOptions(), CancellationToken.None);
        ...
        await svc.ExportMarkdownAsync(id, dest1, new ExportOptions(), CancellationToken.None);
